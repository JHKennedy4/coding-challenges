...
},{"../models/SingleCampaign.js":3,"backbone":12,"jquery-untouched":21,"underscore":22}],2:[function(require,module,exports){
var $ = require('jquery-untouched');
var Backbone = require('backbone');
...
},{"./collections/Campaigns.js":1,"./views/Campaigns.js":6,"./views/Input.js":7,"backbone":12,"jquery-untouched":21}],3:[function(require,module,exports){
var Backbone = require('backbone');
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<h1>Indiegogo Campaigns</h1>\n<div class=\"input\">\n    <label for=\"filter\"><h3>Search</h3></label>\n<form action=\"\">\n    <input id=\"filter\" type=\"text\">\n</form>\n</div>\n\n";
  });

},{"hbsfy/runtime":20}],5:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<a href=\"https://www.indiegogo.com/projects/";
  ...
  buffer += escapeExpression(stack1)
    + " image\" src=\""
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.image_types)),stack1 == null || stack1 === false ? stack1 : stack1.baseball_card)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\"></a>\n<h2 class=\"title\">";
  if (helper = helpers.title) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.title); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
  ...
  if (helper = helpers.percent_completed) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.percent_completed); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "%</div>\n";
  return buffer;
  });

},{"hbsfy/runtime":20}],6:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"../collections/Campaigns.js":1,"../views/SingleCampaign.js":8,"backbone":12,"backbone.marionette":9,"jquery-untouched":21}],7:[function(require,module,exports){
var Backbone = require('backbone');
var _ = require('underscore');
...
},{"../templates/Input.hbs":4,"backbone":12,"underscore":22}],8:[function(require,module,exports){
var Backbone = require('backbone');
var $ = require('jquery-untouched');
Backbone.$ = $;
...
},{"../templates/SingleCampaign.hbs":5,"backbone":12,"jquery-untouched":21}],9:[function(require,module,exports){
...
},{"backbone":12,"backbone.babysitter":10,"backbone.wreqr":11,"underscore":22}],10:[function(require,module,exports){
// Backbone.BabySitter
// -------------------
// v0.1.6
//
...
},{"backbone":12,"underscore":22}],11:[function(require,module,exports){
...
},{"backbone":12,"underscore":22}],12:[function(require,module,exports){
//     Backbone.js 1.1.2
